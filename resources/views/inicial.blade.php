...
<div style="background-image:url('img/iniciofundo/fundo.svg');"> 
    <div style="background-image:url('img/iniciofundo/balonchat.svg'); background-repeat:no-repeat;at; background-position:left"> 
 ...
 <h> 
   @if (Route::has('login'))
            ...
            <a href="https://twitter.com/login?lang=pt"><img src="{{asset('img/brasil/twitter.svg')}}" alt="tt" style="float:right"/></a> 
            <a href="https://pt-br.facebook.com/"><img src="{{asset('img/brasil/facebook.svg')}}" alt="Facebook" style="float:right"/></a>
            <img src="{{asset('img/brasil/brasa.svg')}}" alt="Brasa" style="float:right"/>
  ...
  <div>
    <center><a href="chat.blade.php"><button style="background-color:#641DA3; border-radius:5px; color:white; height:71px; width:10%; font-size:20px">Texto</button></a> 
    ...
    <center>
      <button style="background-color:#641DA3; border-radius:5px; height:71px; width:10%; font-size:20px" >
           @if (Route::has('register'))
                        ...
                        @endif
                    @endauth</button></center>

    <br><br><br><br><br>
    <center><h>This site is protected by reCAPTCHA and the Google Privacy Policy and Terms of Service apply.</h></center>
